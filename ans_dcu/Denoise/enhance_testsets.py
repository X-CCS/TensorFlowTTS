...
def denoisy(signal):
    ...
    json_path = os.path.join('/home/project/TensorFlowTTS_origin/ans_dcu/Denoise/exp/unet16.json')
    params = utils.Params(json_path)
    net = Unet(params.model).cuda()
    checkpoint = torch.load('/home/project/TensorFlowTTS_origin/ans_dcu/Denoise/ckpt/step00110.pth.tar')
